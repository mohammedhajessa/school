                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$Students->student_code}}" class="form-control" name="student_code" type="text" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input  value="{{$Students->Trust}}"class="form-control" name="Trust" type="text" >
                                </div>
                                @error('Trust')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input  value="{{$Students->record}}" class="form-control" name="record" type="text" >
                                </div>
                                @error('record')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$Students->record_number}}" class="form-control" name="record_number" type="text" >
                                </div>
                                @error('record_number')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{$Students->record_place}}" class="form-control" name="record_place" type="text" >
                                </div>
                                @error('record_place')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input  value="{{$Students->place_birth}}" class="form-control" name="place_birth" type="text"  >
                                </div>
                                @error('place_birth')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="current_province_id">
                                        ...
                                        <option value="{{$city->id}}" {{$city->id == $Students->current_province_id ? 'selected' : ""}}>{{ $city->Name }}</option>
                                        @endforeach
                                    </select>
                                    @error('current_city')
                                    <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="original_province_id">
                                        <option selected disabled>{{trans('Students_trans.Choose')}}...</option>
                                        @foreach($citys as $city)
                                            <option value="{{$city->id}}" {{$city->id == $Students->original_province_id ? 'selected' : ""}}>{{ $city->Name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('original_city')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="parent_id">
                                        ...
                                        @foreach($parents as $parent)
                                            ...
                                            <option value="{{ $parent->id }}" {{ $parent->id == $Students->parent_id ? 'selected' : ""}}>{{ $parent->Name_Mother }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
